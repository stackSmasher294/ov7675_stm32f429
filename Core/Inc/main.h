...
/* Private defines -----------------------------------------------------------*/
#define CD0_Pin GPIO_PIN_2
#define CD0_GPIO_Port GPIOE
#define CD1_Pin GPIO_PIN_3
#define CD1_GPIO_Port GPIOE
#define CD2_Pin GPIO_PIN_4
#define CD2_GPIO_Port GPIOE
#define CD3_Pin GPIO_PIN_5
#define CD3_GPIO_Port GPIOE
#define CD4_Pin GPIO_PIN_6
#define CD4_GPIO_Port GPIOE
...
#define CAM_XCLK_Pin GPIO_PIN_5
...
#define CAM_HSYNC_GPIO_Port GPIOD
#define CAM_VSYNC_Pin GPIO_PIN_5
#define CAM_VSYNC_GPIO_Port GPIOD
...
#define CD5_Pin GPIO_PIN_3
#define CD5_GPIO_Port GPIOB
#define CD6_Pin GPIO_PIN_4
#define CD6_GPIO_Port GPIOB
#define SDCKE1_Pin GPIO_PIN_5
#define SDCKE1_GPIO_Port GPIOB
#define SDNE1_Pin GPIO_PIN_6
#define SDNE1_GPIO_Port GPIOB
#define CD7_Pin GPIO_PIN_7
#define CD7_GPIO_Port GPIOB
